...
package discord4j.common.websocket;
...
public class CloseHandlerAdapter extends ChannelInboundHandlerAdapter {
    ...
    private static final Logger log = Loggers.getLogger(CloseHandlerAdapter.class);

    private final AtomicReference<CloseStatus> closeStatus;

    public CloseHandlerAdapter(AtomicReference<CloseStatus> closeStatus) {
